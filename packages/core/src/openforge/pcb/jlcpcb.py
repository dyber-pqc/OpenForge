...
JLC_BASIC_PARTS: list[LcscPart] = [
    ...
    LcscPart(
        ...
        name="100nF 0603 X7R 50V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
        description="100nF 50V X7R 0603 +/-10%",
        price_per_unit=0.0010,
        stock=999999,
        is_basic=True,
    ),
    LcscPart(
        lcsc_part_number="C15849",
        name="10nF 0603 X7R 50V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
    ...
    LcscPart(
        lcsc_part_number="C1591",
        name="1nF 0603 X7R 50V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
    ...
    LcscPart(
        lcsc_part_number="C1525",
        name="22pF 0603 NP0 50V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
    ...
    LcscPart(
        lcsc_part_number="C1546",
        name="33pF 0603 NP0 50V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
    ...
    LcscPart(
        lcsc_part_number="C19702",
        name="1uF 0603 X7R 25V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
    ...
    LcscPart(
        lcsc_part_number="C19702",
        name="4.7uF 0603 X5R 10V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
        description="4.7uF 10V X5R 0603 +/-20%",
        price_per_unit=0.0020,
        stock=999999,
        is_basic=True,
    ),
    LcscPart(
        lcsc_part_number="C19702",
        name="10uF 0603 X5R 10V",
        package="0603",
        manufacturer="Samsung Electro-Mechanics",
        description="10uF 10V X5R 0603 +/-20%",
        price_per_unit=0.0030,
        stock=999999,
        is_basic=True,
    ),
    ...
    LcscPart(
        lcsc_part_number="C52923",
        name="1uF 0402 X5R 10V",
        package="0402",
        manufacturer="Samsung Electro-Mechanics",
        description="1uF 10V X5R 0402 +/-20%",
        price_per_unit=0.0018,
        stock=999999,
        is_basic=True,
    ),
    # --- Electrolytic / tantalum ---
    LcscPart(
        lcsc_part_number="C16133",
        name="10uF 25V electrolytic",
    ...
    LcscPart(
        lcsc_part_number="C57279",
        name="Ferrite bead 0603 600R",
        package="0603",
        manufacturer="Sunlord",
    ...
    LcscPart(
        lcsc_part_number="C84256",
        name="Yellow LED 0603",
        package="0603",
        manufacturer="Everlight",
    ...
    LcscPart(
        lcsc_part_number="C8598",
        name="SS14 SMA Schottky",
        package="SMA",
        manufacturer="MDD",
    ...
    LcscPart(
        lcsc_part_number="C2765",
        name="SS34 SMB Schottky",
        package="SMB",
        manufacturer="MDD",
    ...
    # --- Transistors ---
    LcscPart(
        lcsc_part_number="C20526",
        name="MMBT3904 SOT-23",
        package="SOT-23",
        manufacturer="Changjiang Electronics",
    ...
    LcscPart(
        lcsc_part_number="C20527",
        name="MMBT3906 SOT-23",
        package="SOT-23",
        manufacturer="Changjiang Electronics",
    ...
    LcscPart(
        lcsc_part_number="C8492",
        name="AO3400A SOT-23 NMOS",
        package="SOT-23",
    ...
    LcscPart(
        lcsc_part_number="C15127",
        name="AO3401A SOT-23 PMOS",
        package="SOT-23",
        manufacturer="Alpha & Omega",
    ...
    LcscPart(
        lcsc_part_number="C46398",
        name="Micro USB 5-pin",
        package="Micro-B",
        manufacturer="Korean Hroparts",
    ...
    # --- Logic / common ICs ---
    LcscPart(
        lcsc_part_number="C7420",
        name="74HC595 SOIC-16",
        package="SOIC-16",
        manufacturer="TI",
    ...
    # --- Crystals ---
    LcscPart(
        lcsc_part_number="C13738",
        name="8MHz crystal HC-49",
        package="HC-49S-SMD",
    ...
    LcscPart(
        lcsc_part_number="C12674",
        name="16MHz crystal HC-49",
        package="HC-49S-SMD",
        manufacturer="Yangxing Tech",
...
class JlcPartPicker:
    ...
    def find_for_value(self, value: str, package: str, kind: str = "resistor") -> list[LcscPart]:
        ...
        for p in self._parts:
            ...
            if v and v not in name_low:
                continue
            if kind == "resistor" and not any(u in name_low for u in ("r ", "ohm", "k ", "m ")):
                continue
    ...
    def export_jlc_bom(self, board: PcbBoard, output_path: Path) -> Path:
        ...
        with output_path.open("w", newline="", encoding="utf-8") as f:
            ...
            for (value, footprint, lcsc), refs in groups.items():
                refs_sorted = sorted(
                    refs, key=lambda r: (r[0], int("".join(c for c in r if c.isdigit()) or "0"))
                )
