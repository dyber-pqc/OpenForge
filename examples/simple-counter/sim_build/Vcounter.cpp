...
void Vcounter___024root__trace_decl_types(VerilatedFst* tracep);

void Vcounter___024root__trace_init_top(Vcounter___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vcounter::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vcounter::trace()' called on non-VerilatedFstC object;"
